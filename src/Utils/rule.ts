...
function RuleCreator(urlCreator: (ruleName: string) => string) {
    ...
    >({
        ...
        name,
        ...rule
    }: Readonly<TSESLint.Linter.RuleWithMetaAndName<TOptions, TMessageIds>>): RuleModule<TMessageIds, TOptions> {
...
>({
    ...
    return {
        create: ((
            context: Readonly<TSLIRuleContext<TMessageIds, TOptions>>,
        ): RuleListener => {
